...
from ..Terminal import Enums

from ..Terminal.Struct import Color, MouseInfo, BorderInfo, AnsiStr
from ..Exceptions import InvalidArgumentException
from ..Iterable import SpinQueue
from ..Concurrent import ThreadedPromise, Promise
from ..Connection import NamedPipe
from ..Terminal import Terminal
...
class Widget:
	def __init__(self, parent: Terminal.Terminal | SubTerminal, x: int, y: int, z: int, width: int, height: int, *,
				 callback: typing.Optional[typing.Callable[[type[Widget], str, ...], typing.Any]] = ..., on_focus: typing.Optional[typing.Callable[[type[Widget]], typing.Any]] = ..., off_focus: typing.Optional[typing.Callable[[type[Widget]], typing.Any]] = ..., on_mouse_enter: typing.Optional[typing.Callable[[type[Widget], MouseInfo], typing.Any]] = ..., on_mouse_leave: typing.Optional[typing.Callable[[type[Widget], MouseInfo], typing.Any]] = ..., on_mouse_press: typing.Optional[typing.Callable[[type[Widget], MouseInfo], typing.Any]] = ..., on_mouse_release: typing.Optional[typing.Callable[[type[Widget], MouseInfo], typing.Any]] = ..., on_mouse_click: typing.Optional[typing.Callable[[type[Widget], MouseInfo], typing.Any]] = ..., on_tick: typing.Optional[typing.Callable[[type[Widget], int], typing.Any]] = ..., on_close: typing.Optional[typing.Callable[[type[Widget]], typing.Any]] = ...):
		assert isinstance(parent, (Terminal.Terminal, SubTerminal)), f'Not a terminal or sub-terminal - {type(parent)}'
	...
	def __reduce__(self) -> tuple[typing.Callable, tuple, dict]:
		topmost: Terminal.WindowTerminal.SubprocessTerminal | Terminal.Terminal = self.topmost_parent()
	...
	def configure(self, *, x: typing.Optional[int] = ..., y: typing.Optional[int] = ..., z: typing.Optional[int] = ..., width: typing.Optional[int] = ..., height: typing.Optional[int] = ...,
				  callback: typing.Optional[typing.Callable[[type[Widget], str, ...], None]] = ..., on_focus: typing.Optional[typing.Callable[[type[Widget]], None]] = ..., off_focus: typing.Optional[typing.Callable[[type[Widget]], None]] = ..., on_mouse_enter: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_mouse_leave: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_mouse_press: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_mouse_release: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_mouse_click: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_tick: typing.Optional[typing.Callable[[type[Widget], int], None]] = ..., on_close: typing.Optional[typing.Callable[[type[Widget]], None]] = ...) -> None:
...
class Checkbox(Widget):
	def __init__(self, parent: Terminal.Terminal | SubTerminal, x: int, y: int, *, z_index: int = 0, text: str | AnsiStr = '', active_text: str | AnsiStr = 'X',
				 border: typing.Optional[BorderInfo] = ..., highlight_border: typing.Optional[BorderInfo] = ..., active_border: typing.Optional[BorderInfo] = ...,
				 color_bg: typing.Optional[Enums.Color_T] = ..., color_fg: typing.Optional[Enums.Color_T] = ..., highlight_color_bg: typing.Optional[Enums.Color_T] = ..., highlight_color_fg: typing.Optional[Enums.Color_T] = ..., active_color_bg: typing.Optional[Enums.Color_T] = ..., active_color_fg: typing.Optional[Enums.Color_T] = ...,
				 callback: typing.Optional[typing.Callable[[type[Widget], str, ...], None]] = ..., on_focus: typing.Optional[typing.Callable[[type[Widget]], None]] = ..., off_focus: typing.Optional[typing.Callable[[type[Widget]], None]] = ..., on_mouse_enter: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_mouse_leave: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_mouse_press: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_mouse_release: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_mouse_click: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_tick: typing.Optional[typing.Callable[[type[Widget], int], None]] = ..., on_close: typing.Optional[typing.Callable[[type[Widget]], None]] = ..., on_checked: typing.Optional[typing.Callable[[type[Widget], bool], None]] = ...):
		...
		self.__fg_color__: tuple[Color, Color, Color] = (color_fg, highlight_color_fg, active_color_fg)
		self.__state__: bool = False
		self.__on_checked__: typing.Optional[typing.Callable[[type[Widget], bool], None]] = on_checked
	...
	def configure(self, *, x: typing.Optional[int] = ..., y: typing.Optional[int] = ..., z_index: typing.Optional[int] = ..., width: typing.Optional[int] = ..., height: typing.Optional[int] = ...,
		...
		text: AnsiStr = None if text is None or text is ... else AnsiStr(text)
		active_text: AnsiStr = None if active_text is None or active_text is ... else AnsiStr(active_text)
		...
		color_fg = self.__fg_color__[0] if color_fg is ... else parse_color(color_fg, InvalidArgumentException(Button.__init__, 'color_fg', type(color_fg), (Color,)))
		highlight_color_fg = self.__fg_color__[1] if highlight_color_fg is ... else parse_color(highlight_color_fg, InvalidArgumentException(Button.__init__, 'highlight_color_fg', type(highlight_color_fg), (Color,)))
		active_color_fg = self.__fg_color__[2] if active_color_fg is ... else parse_color(active_color_fg, InvalidArgumentException(Button.__init__, 'active_color_fg', type(active_color_fg), (Color,)))
		...
		self.__bg_color__: tuple[Color, Color, Color] = (color_bg, highlight_color_bg, active_color_bg)
		self.__fg_color__: tuple[Color, Color, Color] = (color_fg, highlight_color_fg, active_color_fg)
		self.__on_checked__: typing.Optional[typing.Callable[[type[Widget], bool], None]] = self.__on_checked__ if on_checked is ... else on_checked
...
class Dropdown(Widget):
	...
	def __init__(self, parent: Terminal.Terminal | SubTerminal, x: int, y: int, width: int, height: int, choices: tuple[str | AnsiStr, ...], *, z_index: int = 0, justify: int = Enums.CENTER,
				 display_count: int | None = None, word_wrap: int = Enums.WORDWRAP_WORD, allow_scroll_rollover: bool = False, on_select: typing.Optional[typing.Callable[[type[Widget], bool], bool | None]] = ...,
				 border: typing.Optional[BorderInfo] = ..., highlight_border: typing.Optional[BorderInfo] = ..., active_border: typing.Optional[BorderInfo] = ...,
				 color_bg: typing.Optional[Enums.Color_T] = ..., color_fg: typing.Optional[Enums.Color_T] = ..., highlight_color_bg: typing.Optional[Enums.Color_T] = ..., highlight_color_fg: typing.Optional[Enums.Color_T] = ..., active_color_bg: typing.Optional[Enums.Color_T] = ..., active_color_fg: typing.Optional[Enums.Color_T] = ...,
				 callback: typing.Optional[typing.Callable[[type[Widget], str, ...], None]] = ..., on_focus: typing.Optional[typing.Callable[[type[Widget]], None]] = ..., off_focus: typing.Optional[typing.Callable[[type[Widget]], None]] = ..., on_mouse_enter: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_mouse_leave: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_mouse_press: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_mouse_release: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_mouse_click: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_tick: typing.Optional[typing.Callable[[type[Widget], int], None]] = ..., on_close: typing.Optional[typing.Callable[[type[Widget]], None]] = ...):
		...
		self.__on_select__: typing.Callable[[type[Widget], bool], bool | None] = on_select
	...
	def configure(self, *, x: typing.Optional[int] = ..., y: typing.Optional[int] = ..., z_index: typing.Optional[int] = ..., width: typing.Optional[int] = ..., height: typing.Optional[int] = ...,
				  callback: typing.Optional[typing.Callable[[type[Widget], str, ...], None]] = ..., on_focus: typing.Optional[typing.Callable[[type[Widget]], None]] = ..., off_focus: typing.Optional[typing.Callable[[type[Widget]], None]] = ..., on_mouse_enter: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_mouse_leave: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_mouse_press: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_mouse_release: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_mouse_click: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_tick: typing.Optional[typing.Callable[[type[Widget], int], None]] = ..., on_close: typing.Optional[typing.Callable[[type[Widget]], None]] = ...,
				  choices: typing.Optional[tuple[str | AnsiStr, ...]] = ..., display_count: typing.Optional[int | None] = ..., justify: int = Enums.CENTER, allow_scroll_rollover: bool = False, word_wrap: int = Enums.WORDWRAP_WORD, on_select: typing.Optional[typing.Callable[[type[Widget]], bool | None]] = ...,
				  border: typing.Optional[BorderInfo] = ..., highlight_border: typing.Optional[BorderInfo] = ..., active_border: typing.Optional[BorderInfo] = ...,
				  color_bg: typing.Optional[Enums.Color_T] = ..., color_fg: typing.Optional[Enums.Color_T] = ..., highlight_color_bg: typing.Optional[Enums.Color_T] = ..., highlight_color_fg: typing.Optional[Enums.Color_T] = ..., active_color_bg: typing.Optional[Enums.Color_T] = ..., active_color_fg: typing.Optional[Enums.Color_T] = ...,
				  ) -> None:
		super().configure(x=x, y=y, z=z_index, width=width, height=height, callback=callback, on_focus=on_focus, off_focus=off_focus, on_mouse_enter=on_mouse_enter, on_mouse_leave=on_mouse_leave, on_mouse_press=on_mouse_press, on_mouse_release=on_mouse_release, on_mouse_click=on_mouse_click, on_tick=on_tick, on_close=on_close)
...
class SubTerminal(Widget):
	...
	def __init__(self, parent: Terminal.Terminal | SubTerminal, x: int, y: int, width: int, height: int, name: str = '', *, z_index: int = 0, transparent: bool = False,
		...
		self.__border__: tuple[BorderInfo | None, BorderInfo | None, BorderInfo | None] = (border, highlight_border, active_border)
		self.__widgets__: dict[int, dict[int, typing.Type[type[Widget] | Widget]]] = {}
	...
	def get_widget(self, _id: int) -> typing.Type[type[Widget]]:
	...
	def add_checkbox(self, x: int, y: int, *, z_index: int = 0, text: str = '', active_text: str = 'X',
					 border: typing.Optional[BorderInfo] = ..., highlight_border: typing.Optional[BorderInfo] = ..., active_border: typing.Optional[BorderInfo] = ...,
					 color_bg: typing.Optional[Enums.Color_T] = ..., color_fg: typing.Optional[Enums.Color_T] = ..., highlight_color_bg: typing.Optional[Enums.Color_T] = ..., highlight_color_fg: typing.Optional[Enums.Color_T] = ..., active_color_bg: typing.Optional[Enums.Color_T] = ..., active_color_fg: typing.Optional[Enums.Color_T] = ...,
					 callback: typing.Optional[typing.Callable[[type[Widget], str, ...], None]] = ..., on_focus: typing.Optional[typing.Callable[[type[Widget]], None]] = ..., off_focus: typing.Optional[typing.Callable[[type[Widget]], None]] = ..., on_mouse_enter: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_mouse_leave: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_mouse_press: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_mouse_release: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_mouse_click: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_tick: typing.Optional[typing.Callable[[type[Widget], int], None]] = ..., on_close: typing.Optional[typing.Callable[[type[Widget]], None]] = ..., on_checked: typing.Optional[typing.Callable[[type[Widget], bool], None]] = ...) -> Checkbox:
	...
	def add_inline_checkbox(self, x: int, y: int, *, z_index: int = 0, text: str = '', active_text: str = 'X',
							border: typing.Optional[BorderInfo] = ..., highlight_border: typing.Optional[BorderInfo] = ..., active_border: typing.Optional[BorderInfo] = ...,
							color_bg: typing.Optional[Enums.Color_T] = ..., color_fg: typing.Optional[Enums.Color_T] = ..., highlight_color_bg: typing.Optional[Enums.Color_T] = ..., highlight_color_fg: typing.Optional[Enums.Color_T] = ..., active_color_bg: typing.Optional[Enums.Color_T] = ..., active_color_fg: typing.Optional[Enums.Color_T] = ...,
							callback: typing.Optional[typing.Callable[[type[Widget], str, ...], None]] = ..., on_focus: typing.Optional[typing.Callable[[type[Widget]], None]] = ..., off_focus: typing.Optional[typing.Callable[[type[Widget]], None]] = ..., on_mouse_enter: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_mouse_leave: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_mouse_press: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_mouse_release: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_mouse_click: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_tick: typing.Optional[typing.Callable[[type[Widget], int], None]] = ..., on_close: typing.Optional[typing.Callable[[type[Widget]], None]] = ..., on_checked: typing.Optional[typing.Callable[[type[Widget], bool], None]] = ...) -> InlineCheckbox:
	...
	def add_dropdown(self, x: int, y: int, width: int, height: int, choices: tuple[str | AnsiStr, ...], *, display_count: int | None = None, allow_scroll_rollover: bool = False, z_index: int = 0, justify: int = Enums.CENTER, word_wrap: int = Enums.WORDWRAP_WORD, on_select: typing.Optional[typing.Callable[[type[Widget]], bool | None]] = ...,
				   border: typing.Optional[BorderInfo] = ..., highlight_border: typing.Optional[BorderInfo] = ..., active_border: typing.Optional[BorderInfo] = ...,
				   color_bg: typing.Optional[Enums.Color_T] = ..., color_fg: typing.Optional[Enums.Color_T] = ..., highlight_color_bg: typing.Optional[Enums.Color_T] = ..., highlight_color_fg: typing.Optional[Enums.Color_T] = ..., active_color_bg: typing.Optional[Enums.Color_T] = ..., active_color_fg: typing.Optional[Enums.Color_T] = ...,
				   callback: typing.Optional[typing.Callable[[type[Widget], str, ...], None]] = ..., on_focus: typing.Optional[typing.Callable[[type[Widget]], None]] = ..., off_focus: typing.Optional[typing.Callable[[type[Widget]], None]] = ..., on_mouse_enter: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_mouse_leave: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_mouse_press: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_mouse_release: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_mouse_click: typing.Optional[typing.Callable[[type[Widget], MouseInfo], None]] = ..., on_tick: typing.Optional[typing.Callable[[type[Widget], int], None]] = ..., on_close: typing.Optional[typing.Callable[[type[Widget]], None]] = ...) -> Dropdown:
	...
	def add_widget[T: Widget](self, cls: type[T], *args, z_index: int = 0, **kwargs) -> typing.Generic[T]:
		assert issubclass(cls, Widget)
		widget: Widget = cls(self, *args, **kwargs)
		_id: int = id(widget)
...
class SerializedWidget:
	...
	def __init__(self, conn: NamedPipe, widget: Widget | None):
		assert not conn.closed, 'The pipe is closed'

		self.__conn__: NamedPipe = conn
